<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="(order, index) in orderInfo.detailArrayList" :key="order.skuId">
          <li>
            <img :src="order.imgUrl" alt="" style="width: 100px; heihgt: 100px" />
          </li>
          <li>
    ...
    <div class="sub clearFix">
      <span class="subBtn" @click="submitOrder">提交订单</span>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        ...
        //  商品清单
        orderDetailList:this.orderInfo.orderDetailList,
      }
      ...
      if (result.code == 200) {
        //  订单提交成功
        //  存储订单号
        this.orderId = result.data || '10552'
        //  跳转到支付页，携带参数
